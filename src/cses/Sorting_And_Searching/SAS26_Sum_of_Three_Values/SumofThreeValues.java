package cses.Sorting_And_Searching.SAS26_Sum_of_Three_Values;
...
and your task is to find three values (at distinct positions) whose sum is x.
...
public class SumofThreeValues {
    ...
    public static void main(String[] args) throws Exception {
        inputStream = LOCAL ? new FileInputStream("src/cses/Sorting_And_Searching/SAS26_Sum_of_Three_Values/input.txt") : System.in;
        outputStream = LOCAL ? new FileOutputStream("src/cses/Sorting_And_Searching/SAS26_Sum_of_Three_Values/output.txt") : System.out;
