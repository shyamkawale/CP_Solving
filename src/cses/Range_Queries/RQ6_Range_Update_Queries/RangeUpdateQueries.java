package cses.Range_Queries.RQ6_Range_Update_Queries;
...
public class RangeUpdateQueries {
    ...
    public static void main(String[] args) throws Exception {
        inputStream = LOCAL ? new FileInputStream("src/cses/Range_Queries/RQ6_Range_Update_Queries/input.txt") : System.in;
        outputStream = LOCAL ? new FileOutputStream("src/cses/Range_Queries/RQ6_Range_Update_Queries/output.txt")
                : System.out;
