package cses.Range_Queries.RQ1_Static_Range_Sum_Queries;
...
public class StaticRangeSumQueries {
    ...
    public static void main(String[] args) throws Exception {
        inputStream = LOCAL ? new FileInputStream("src/cses/Range_Queries/Static_Range_Sum_Queries/input.txt")
                : System.in;
        outputStream = LOCAL ? new FileOutputStream("src/cses/Range_Queries/Static_Range_Sum_Queries/output.txt")
                : System.out;
