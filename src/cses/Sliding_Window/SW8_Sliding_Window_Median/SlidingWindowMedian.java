package cses.Sliding_Window.SW8_Sliding_Window_Median;
...
public class SlidingWindowMedian {
    ...
    public static void main(String[] args) throws Exception {
        inputStream = LOCAL ? new FileInputStream("src/cses/Sliding_Window/SW8_Sliding_Window_Median/input.txt")
                : System.in;
        outputStream = LOCAL ? new FileOutputStream("src/cses/Sliding_Window/SW8_Sliding_Window_Median/output.txt")
                : System.out;
