package cses.Sliding_Window.SW6_Sliding_Window_Mode;
...
public class SlidingWindowMode {
    ...
    public static void main(String[] args) throws Exception {
        inputStream = LOCAL ? new FileInputStream("src/cses/Sliding_Window/SW6_Sliding_Window_Mode/input.txt") : System.in;
        outputStream = LOCAL ? new FileOutputStream("src/cses/Sliding_Window/SW6_Sliding_Window_Mode/output.txt")
                : System.out;
