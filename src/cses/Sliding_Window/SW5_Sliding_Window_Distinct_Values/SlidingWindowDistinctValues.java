package cses.Sliding_Window.SW5_Sliding_Window_Distinct_Values;
...
public class SlidingWindowDistinctValues {
    ...
    public static void main(String[] args) throws Exception {
        inputStream = LOCAL ? new FileInputStream("src/cses/Sliding_Window/SW5_Sliding_Window_Distinct_Values/input.txt")
                : System.in;
        outputStream = LOCAL ? new FileOutputStream("src/cses/Sliding_Window/SW5_Sliding_Window_Distinct_Values/output.txt")
                : System.out;
