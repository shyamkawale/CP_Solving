package cses.Sliding_Window.SW7_Sliding_Window_Mex;
...
public class SlidingWindowMex {
    ...
    public static void main(String[] args) throws Exception {
        inputStream = LOCAL ? new FileInputStream("src/cses/Sliding_Window/SW7_Sliding_Window_Mex/input.txt") : System.in;
        outputStream = LOCAL ? new FileOutputStream("src/cses/Sliding_Window/SW7_Sliding_Window_Mex/output.txt")
                : System.out;
