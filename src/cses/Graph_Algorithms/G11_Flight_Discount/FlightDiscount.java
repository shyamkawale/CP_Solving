package cses.Graph_Algorithms.G11_Flight_Discount;
...
public class FlightDiscount {
    ...
    public static void main(String[] args) throws Exception {
        inputStream = LOCAL ? new FileInputStream("src/cses/Graph_Algorithms/G11_Flight_Discount/input.txt")
                : System.in;
        outputStream = LOCAL ? new FileOutputStream("src/cses/Graph_Algorithms/G11_Flight_Discount/output.txt")
                : System.out;
