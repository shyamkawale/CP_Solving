package cses.Trees.Subordinates;
...
public class Subordinates {
    ...
    public static void main(String[] args) throws Exception {
        inputStream = LOCAL ? new FileInputStream("src/cses/Trees/Subordinates/input.txt") : System.in;
        outputStream = LOCAL ? new FileOutputStream("src/cses/Trees/Subordinates/output.txt") : System.out;
